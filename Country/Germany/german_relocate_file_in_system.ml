...
#use"Country/Germany/german_relocate_file_in_system.ml";;
...
let relocate_module mdata old_name new_subdir=
...
let make_module_optional mdata old_name=
    ...
    relocate_module mdata old_name (Subdirectory.of_string "Optional");;    
