...
#install_printer Php_projected_token_set.print_out;;
...
#install_printer Php_positioned_token_list.print_out;;
#install_printer Rat_frac.print_out;;
#install_printer Php_named_recognizer.print_out;;
#install_printer Php_positioned_molecule_list.print_out;;
