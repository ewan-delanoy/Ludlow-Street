...
let returnable=
      dis "returnable"
       [ 
         ...
         (ch "rtripod2"              [namespaced_name;paren_block;whites;question_mark;whites;center_of_tripod;whites;colon;whites;left_of_tripod]); 
         ...
         (ch "new_meth_call1"        [new_kwd;white_spot;php_vname;whites;arrow;php_name]); 
                                     null_kwd;                              
         (ch "rtripod3"              [paren_block;whites;question_mark;whites;center_of_tripod;whites;colon;whites;left_of_tripod]); 
