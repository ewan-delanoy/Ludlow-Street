...
let returnable=
      dis "returnable"
       [ 
         ...
         (ch "returnable11b"          [php_vname;arrow;php_name;paren_block;wap;paren_block;white_spot;arrow;php_name;whites;possible_paren_block;whites;starred_snippet_in_snake]);
