...
let returnable=
      dis "returnable"
       [ 
         ...
         (ch "returnable12"          [php_vname;wap;paren_block;wap;paren_block;white_spot;point;whites;php_vname]);
         (ch "returnable13"          [php_vname;wap;paren_block;wap;paren_block]);
         (ch "returnable14"          [php_vname;wap;paren_block]);
         (ch "returnable15"          [php_vname;wap;white_spot;point;whites;myriam]);
         (ch "returnable16"          [php_vname;wap]);
         (ch "returnable17"          [php_vname;whites;point;whites;myriam]);
                                      php_vname; 
