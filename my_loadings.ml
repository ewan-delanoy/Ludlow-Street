...
#load"GParser/hparser_result.cmo";;
#load"GParser/hparser.cmo";;
#load"GParser/hparser_for_ocaml_language.cmo";;
#load"GParser/hparser_fun.cmo";;
#load"GParser/hparser_apply.cmo";;
#load"Ocaml_analysis/gdecompose_ocaml_text.cmo";;
#load"nonblank.cmo";;
...
#load"GParser/hparser_for_c_language.cmo";;
