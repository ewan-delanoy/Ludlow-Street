...
#load"nonatomic_jrecognizer.cmo";;
#load"standard_jdisjunction.cmo";;
#load"special_chars_for_hrecognizer_name.cmo";;
#load"atomic_hrecognize.cmo";;
#load"parametric_hrecognize.cmo";;
#load"order_for_jrecognizer_chains.cmo";;
#load"nonatomic_jrecognize.cmo";;
...
#load"check_jrecognizers_disjointness.cmo";;
