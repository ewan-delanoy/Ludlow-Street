...
#use"Makefile_makers/create_target_system.ml";;
...
let from_prepared_list dir opt l=
   ...
   let ms=Modulesystem.from_root_and_toplevel dir opt in
   Modify_modulesystem.try_to_register_mlx_files ms temp1;;
...
let from_main_directory dir=
   ...
   let ts2=Modify_target_system.look_for_printers ts1 in
   let tl1=Toplevel_from_modulesystem.toplevel_from_modulesystem fs1 in
   Make_ocaml_target.make ts2 tl1 ;;
